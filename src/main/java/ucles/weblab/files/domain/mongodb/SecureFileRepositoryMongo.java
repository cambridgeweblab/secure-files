...
//    private final GridFsTemplate gridFsTemplate;
    ...
    @Autowired
    public SecureFileRepositoryMongo(MongoOperations mongoOperations, MongoDatabaseFactory mongoDbFactory, EncryptionService encryptionService) {
    ...
    private GridFS getGridFS(SecureFileCollectionEntityMongo bucket) {
        DB legacyDb = null; // FIXME Migrate off legacy as Spring Data no longer supports it mongoDbFactory.getLegacyDb();
        final GridFS gridFS = new GridFS(legacyDb, bucket.getBucket());
        return gridFS;
    }
}
